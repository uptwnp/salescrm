              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange("preferred_area", e.target.value)
                    }
                ...
                <div>
                  ...
                  <TagInput
                    ...
                    onChange={(values) =>
                      isNewLead
                        ? handleFieldChange("preferred_type", values.join(","))
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ? handleFieldChange("purchase_timeline", e.target.value)
                        : handleImmediateUpdate(
                            "purchase_timeline",
                            e.target.value
                          )
                ...
                <div>
                  ...
                  <TagInput
                    ...
                    onChange={(values) =>
                      isNewLead
                        ? handleFieldChange("size", values.join(","))
                        : handleImmediateUpdate("size", values.join(","))
                    }
                    suggestions={SIZES}
                    allowCustom={false}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ? handleFieldChange("intent", e.target.value)
                        : handleImmediateUpdate("intent", e.target.value)
                    }
                  >
              ...
              <div className="space-y-4">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ...
                        : handleImmediateUpdate("stage", e.target.value)
                    }
                  >
                    <option value="">Not Set</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ? handleFieldChange("visit_status", e.target.value)
                        : handleImmediateUpdate("visit_status", e.target.value)
                    }
                  >
                    <option value="">Not Set</option>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ...
                        : handleImmediateUpdate("next_action", e.target.value)
                    }
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange("next_action_time", e.target.value)
                    }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleFieldChange("next_action_note", e.target.value)
                    }
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange("about_him", e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onBlur={() =>
                      handleFieldBlur("alternative_contact_details")
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ? handleFieldChange("segment", e.target.value)
                        : handleImmediateUpdate("segment", e.target.value)
                    }
                  >
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ...
                        : handleImmediateUpdate("source", e.target.value)
                    }
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      isNewLead
                        ? handleFieldChange("medium", e.target.value)
                        : handleImmediateUpdate("medium", e.target.value)
                    }
                  >
                ...
                <div>
                  ...
                  <TagInput
                    ...
                    onChange={(values) =>
                      isNewLead
                        ? handleFieldChange("list_name", values.join(","))
                        : handleImmediateUpdate("list_name", values.join(","))
                    }
                    suggestions={LISTS}
                    allowCustom={true}
                ...
                <div>
                  ...
                  <TagInput
                    ...
                    onChange={(values) =>
                      isNewLead
                        ? handleFieldChange("assigned_to", values.join(","))
                        : handleImmediateUpdate("assigned_to", values.join(","))
                    }
                ...
                <div>
                  ...
                  <TagInput
                    ...
                    onChange={(values) =>
                      isNewLead
                        ? handleFieldChange("tags", values.join(","))
                        : handleImmediateUpdate("tags", values.join(","))
                    }
                    suggestions={TAGS}
                    allowCustom={true}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange("data_1", e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange("data_2", e.target.value)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFieldChange("data_3", e.target.value)
                    }
